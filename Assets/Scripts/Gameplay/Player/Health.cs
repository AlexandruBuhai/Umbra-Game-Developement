...
public class Health : MonoBehaviour {
	...
	public GUITexture heartGUI; // TODO to change
		...
		foreach (Transform heart in hearts) {
			...
			if (restAreEmpty) {
				...
				if (currentHealth >= i * healthPerHeart) {
					heart.GetComponent<GUITexture>().texture = heartImages[heartImages.Length-1]; // health of current heart is full // this doesn't work anymore
				}
				else {
